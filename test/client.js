...
/***/ function(module, exports) {
	...
	(function(){
		...
		return self.describe('Syntax - Loops',function() {
			var ary = [1,2,3,4,5];
			var ary2 = [2,4,6,8,10];
			...
			self.describe("For Of",function() {
				...
				return self.test("for own of",function() {
					...
					for (var v, i = 0, keys2 = Object.keys(dict2), l2 = keys2.length, res = []; i < l2; i++){
						v = dict2[keys2[i]];res.push(keys2[i]);
					};
					keys = res;
			...
			self.test("nested loops",function() {
				var res = [];
...
/***/ function(module, exports) {
	...
	(function(){
		...
		return self.describe('Syntax - Class',function() {
...
/***/ function(module, exports) {
	...
	(function(){
		...
		return self.describe('Syntax - super',function() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function(){
		...
		return self.describe('Syntax - Operators',function() {
			...
			return self.test("?.",function() {
				...
				self.eq(($1 = o) && $1.meth  &&  $1.meth(),10);
				self.eq(($2 = o) && $2.key,1);
				self.eq(($3 = o) && $3.none  &&  $3.none(),null);
				self.eq((none_ = ($4 = o) && $4.none  &&  $4.none()) && none_.none  &&  none_.none(),null);
				return self.eq((ref_ = o.ref) && ref_.meth  &&  ref_.meth(),10);
			});
		});
...
/***/ function(module, exports) {
	...
	(function(){
		...
		return self.describe("Syntax - Variables",function() {
...
/***/ function(module, exports) {
	...
	(function(){
		...
		return self.describe('Syntax - Arrays',function() {
...
/***/ function(module, exports) {
	...
	(function(){
		...
		return self.describe('Syntax - Catch',function() {
...
/***/ function(module, exports) {
	...
	(function(){
		...
		return self.describe('Syntax - Functions',function() {
...
/***/ function(module, exports) {
	...
	(function(){
		var self = this;
		return self.describe('Syntax - Return',function() {
...
/***/ function(module, exports) {
	...
	(function(){
		...
		return self.describe("Syntax - Statements",function() {
			
			return self.test("allow statements as arguments",function() {
...
/***/ function(module, exports) {
	...
	(function(){
		...
		return self.describe('Syntax - Properties',function() {
...
/***/ function(module, exports) {
	...
	(function(){
		var self = this;
		return self.describe("Syntax - Literals",function() {
			...
			return self.test("strings",function() {
				...
				str = ("test " + 2 + " dette");
				self.eq(str,"test 2 dette");
				
				self.eq(("basic" + 100),"basic100");
				
				str = ("test " + 100 + " 	this");
				
				self.eq(str,"test 100 	this");
				...
				self.eq(str,"test\n\tthis\n\tnow");
				self.eq(("import " + fn(name)),"import john");
				
				str = ("<?xml \" version=\"1.0\" \{ encoding=\"UTF-8\"?>");
				return self.eq(str,'<?xml " version="1.0" { encoding="UTF-8"?>');
			});
		});
...
/***/ function(module, exports) {
	...
	(function(){
		...
		return self.describe('Syntax - Existential operator',function() {
...
/***/ function(module, exports) {
	...
	(function(){
		...
		return self.describe("Syntax - Scope",function() {
			var item = new A(1,1);
...
/***/ function(module, exports) {
	...
	(function(){
		var self = this;
		return self.describe('Syntax - Delete',function() {
...
/***/ function(module, exports) {
	...
	(function(){
		...
		return self.describe('Syntax - Blockparam',function() {
...
/***/ function(module, exports) {
	...
	(function(){
		...
		return self.describe('Syntax - Switch',function() {
...
/***/ function(module, exports) {
	...
	(function(){
		...
		// * Context Property (@) Assignment
		// * Existential Assignment (?=)
		return self.describe('Syntax - Assignment',function() {
...
/***/ function(module, exports) {
	...
	(function(){
		...
		return self.describe("Syntax - Selectors",function() {
...
/***/ function(module, exports) {
	...
	(function(){
		...
		return self.describe("Formatting",function() {
...
/***/ function(module, exports) {
	...
	(function(){
		...
		return self.describe('Issues',function() {
			
			self.test('dynamic new',function() {
				...
				self.ok(new A() instanceof A);
				self.ok(new A.B() instanceof A.B);
				self.ok(new A.B.C() instanceof A.B.C);
				
				self.ok(new (A.b().C)() instanceof A.B.C);
				self.ok(new (A.b().C)() instanceof A.B.C);
				return self.ok(new (a().B)() instanceof A.B);
			});
			
			self.test('var hoisting with loops',function() {
			...
			return self.test('incorrect var lookup with loops',function() {
				...
				self.ok(a.first instanceof Function);
				return self.ok(b.last instanceof Function);
			});
		});
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function(){
		...
		tag$.$a().end();
		tag$.$a().flag('a').flag('b').end();
		tag$.$a().flag('b').setHref("").end();
		tag$.$a().flag('b').flag('c',true).end();
		
		var buildCount = 0;
		
		tag$.defineTag('custom', function(tag){
		...
		tag$.defineTag('cached', function(tag){
		...
		return self.describe('Tags - Define',function() {
			
			self.test("basic",function() {
				var el = tag$.$custom().end();
				eq(el.hello(),true);
				return eq(el.toString(),'<div class="_custom"></div>');
			});
			
			
			self.test("caching",function() {
				var ary;
				var el = tag$.$cached().end();
			...
			// bug
			self.test("as part of object",function() {
				var obj;
				return obj = {
					name: 'something',
					node: tag$.$a().setHref('#').end()
				};
			});
			
			self.test("with switch",function() {
				var el;
				var num = 1;
				// not yet caching with switch
				return el = tag$.$div().setContent(
					tag$.$div().flag('inner').setContent(
						(function() {
							switch (num) {
								case 1:
									return tag$.$div().flag('one').end();
									break;
								
								default:
								
									return tag$.$div().flag('other').end();
			...
			self.test("singleton with reserved names",function() {
				tag$.defineTag('#try', function(tag){
					tag.prototype.hello = function (){
						return true;
					};
				});
				return tag$.$div().setId('try').end();
			});
			
			
			self.test("cache for in",function() {
				buildCount = 0;
